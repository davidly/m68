...
set _clist=SIEVE E TTT TARGS HI TPI MM NQ1D PRIMES NQUEENS T_SETJMP FOPENTST TRW TRW2 FILEOPS TRENAME TBDOS TPRINTF TM
...
rem tests with floating point
set _flist=TPHI TAP TMULDIV TS TF PIS MANDLE
