...
# the Aztec C compiler for 68k is an MS-DOS cross-compiler. Use ntvdm to run the tools.
...
ntvdm -u -r:.. -e:CLIB68=C:\\LIB\\\;PATH=C:\\BIN\\ ../BIN/LN68.EXE +C 8100 -t CPM.R $str.R -lm68 -lC68KF -T -O $str.68K
