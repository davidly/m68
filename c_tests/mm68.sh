...
$gcccmd $defines $incpaths -mcpu=68000 -x c++ -fno-use-cxa-atexit -O2 ../m68.cxx ../m68000.cxx newlib68.c -l:m68start.o -L./ -static-libgcc -l:libm.a -l:libstdc++.a -static -o m68.elf
